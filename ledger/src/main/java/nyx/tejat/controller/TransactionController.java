...
public class TransactionController {
    ...
    @GetMapping("/origin/{accountId}")
    public List<Transaction> getTransactionsOriginatedFromAccount(
            @PathVariable("accountId") @NotNull Long accountId
    ) {
        return this.transactionView.getTransactionsOriginatedFromAccount(accountId);
    }

    @GetMapping("/destination/{accountId}")
    public List<Transaction> getTransactionsDestinatedToAccount(
            @PathVariable("accountId") @NotNull Long accountId
    ) {
        return this.transactionView.getTransactionsDestinatedToAccount(accountId);
    }
}
